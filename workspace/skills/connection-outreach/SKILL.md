...
3. If connected, skim headline, about, recent activity to infer pathway (agency vs business owner) and sharpen the message.
...
| Lead | Company | Score (`lead_score`) | Pathway (inferred) | Connected (verified) | Sent | `outreach_date` | `is_connected` | HubSpot updated |
|------|---------|----------------------|---------------------|----------------------|------|-----------------|----------------|-----------------|
