...
**Before composing:** read `workspace/skills/messaging-guidelines/SKILL.md` and follow it in full for tone, style, and body rules.

**Intent:** One short **second touch** — acknowledge time passed, continue the operational conversation naturally, add **one** new angle or question from the conversation framework. Stay pathway-aware and industry-aware. **Forbidden:** repeating the first message, generic "just circling back" with no new substance, pitching, mentioning AI, or more than **~3-4 short sentences**.
...
- One clear next question or observation; keep it conversational and low pressure.
- Follow tone rules from `messaging-guidelines`: relaxed, natural, slightly imperfect, no marketing language.
...
- **Paste:** Copy that full body and **paste** it into the Sales Navigator thread **Input body** box in one go — do not retype line-by-line in the UI.
